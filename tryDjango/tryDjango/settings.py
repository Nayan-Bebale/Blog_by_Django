...
SECRET_KEY = 'n6(hus&(oy1^pfy%m$o+etq3khq__sew_g0hr^9z!lg#$ep#or'
...
LOGIN_URL = "/login"
LOGIN_REDIRECT_URL = 'blog_post_list_view'
...
MEDIA_ROOT = os.path.join(LOCAL_STATIC_CDN_PATH, 'media')  # Change this line
MEDIA_URL = '/media/'
